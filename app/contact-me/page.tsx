...
const Resume: NextPage = () => {
  ...
  // }
  return (
    <div className="flex gap-5 mt-10 h-full md:flex-col w-full">
      <div className="p-4 text-center text-xl">
        <h3 className="text-amber-600 md:text-3xl text-6xl">Let&apos;s Get in Touch</h3>
        <p className="text-gray-700 dark:text-white/80 mt-10 p-2">
          ...
          <span className="flex items-center justify-center mt-3">or through this form. <FaLongArrowAltRight className="ml-3 text-amber-600 md:hidden" size={"50"}/></span>
        </p>
        <SocialNetwork/>
      </div>
      <div className="grow px-3">
        ...
        <input
          ...
          <textarea
            ...
            maxLength={5000}
          />
          <button type="submit" className="bg-amber-600 p-3 w-[220px] rounded-full md:self-center self-start flex items-center justify-center group hover:scale-110 hover:bg-amber-500 my-5"> Send Message <FaPaperPlane className="text-xs opacity-70 transition-all group-hover:translate-x-1 group-hover:-translate-y-1 ml-2" />{" "} </button>
        </form>
      </div>
    </div>
  );
